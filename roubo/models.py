...
# VERSION 0.13: depuración de TfU.
...
class Recurso(models.Model):
    """
    Representa una publicación genérica que puede verse como una entrada de blog, un tutorial, un proyecto, una biblioteca de recursos comentados, un libro, etc.
    """
    #Constantes
    BLOG = 'BLG'
    GALERIA='GLR'
...
#     nombre=models.TextField(help_text="Un tópico generativo es una idea compleja, profunda, que se conecta con otras ideas o conceptos importantes de una disciplina. Guía el diseño de una unidad curricular. Es comparable con lo otros han llamado grandes ideas. P. ej. La relación entre las preopiedades físicas de la madera y los ensambles.")
...
#     nombre=models.TextField(help_text="Una meta de comprensión identifica lo que se busca que lo estudiantes logren saber y saber hacer. Puede ser un enunciado o una pregunta. P. Ej. Los estudiantes comprenderán cómo utilizar la sierra sinfín de manera segura; o ¿Cómo operar la sierra sinfín de manera segura?")
#     nombre_corto=models.SlugField(
#         max_length=50,
#         blank=True,
#         help_text="Nombre corto que se usa para la URL: letras, números, guiones, rayas). Debe ser único."
...
#     """
#     Un desempeño es la unidad de contenido de un curso o proyecto. Puede ser una clase, una parte de una clase o tomar más de una sesión. Una secuencia de desempeños progresivamente más complejos representa la secuencia básica de un curso. Cada desempeño que busca avanzar hacia el logro de una o más metas de comprensión. Puede ser parte de una secuencia para conformar un curso o proyecto o ser independiente.
#     """
#     #Atributos básicos y obligatorios
#     autor = models.ManyToManyField(
#         settings.AUTH_USER_MODEL,
...
#     """Un curso está definido por un conjunto de tópicos generativos, metas de comprensión, desempeños de comprensión (y recursos relacionados con ellos). Un proyecto es un tipo de curso."""
#     #Constantes
#     ABIERTO_LIBRE = 'AB-L'
