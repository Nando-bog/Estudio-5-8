...
class SiteFeed(Feed):
    ...
    def items(self, request):
        ...
        colecciones = Coleccion.objects.all().order_by('fecha_actualizacion')
        for blog in blogs:
        ...
        for coleccion in colecciones:
            items_feed.append(FeedItem(coleccion.nombre, coleccion.descripcion, coleccion.autor, coleccion.fecha_actualizacion, '', coleccion.get_absolute_url(), coleccion.imagenes.all()[0].imagen))
